...
import { ElMessage, ElMessageBox, type FormRules, type UploadFile, type FormInstance } from "element-plus";
...
const rules: FormRules = {
  ...
  isTimingTask: [{ required: true, message: "请选择是否开启定时任务", trigger: "blur", type: "boolean" }],
  timingTaskTime: [
    {
      required: true,
      message: "请选择定时任务时间",
...
const init = () => {
  if (userStore.getUser) {
    form.value = { ...userStore.getUpdateUser };
